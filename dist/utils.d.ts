 ...
 */
export declare function getIssueContributionsByRepository(octokit: any, username: string, startDate: Date): Promise<IssueContributionsByRepository>;
/**
 ...
 */
export declare function getPullRequestContributionsByRepository(octokit: any, username: string, startDate: Date): Promise<PullRequestContributionsByRepository>;
/**
